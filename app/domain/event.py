...
from app.domain.entity import Entity, PrimaryEntity
...
from app.domain.profile_data import ProfileLoyalty, ProfileJob, ProfilePreference, ProfileMedia, \
    ProfileIdentifier, ProfileContact, ProfilePII
from app.domain.request import Request
from app.domain.value_object.operation import RecordFlag
from app.domain.value_object.storage_info import StorageInfo
from app.service.string_manager import capitalize_event_type_id
