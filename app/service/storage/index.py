...
from app.config import rjm, elastic
...
class Index:
    def __init__(self, multi_index, index, mapping, staging=False, static=False, single=False, partitioning=None):
        ...
        self.index = index
        self._version_prefix = rjm.version.get_version_prefix()  # eg.080
    ...
    def prepare_mappings(self, mapping, index) -> dict:
        ...
        json_map = mapping.replace("%%PREFIX%%", rjm.version.name)
